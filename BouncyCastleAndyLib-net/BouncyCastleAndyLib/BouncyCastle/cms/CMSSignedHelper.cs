...
namespace Org.BouncyCastle.Cms
{
    internal class CmsSignedHelper
    {
		...
		{
			encryptionAlgs.Add(X9ObjectIdentifiers.IdDsaWithSha1.Id, "DSA");
			encryptionAlgs.Add(X9ObjectIdentifiers.IdDsa.Id, "DSA");
			encryptionAlgs.Add(OiwObjectIdentifiers.DsaWithSha1.Id, "DSA");
			encryptionAlgs.Add(PkcsObjectIdentifiers.RsaEncryption.Id, "RSA");
			encryptionAlgs.Add(PkcsObjectIdentifiers.Sha1WithRsaEncryption.Id, "RSA");
...
//			encryptionAlgs.Add(CmsSignedDataGenerator.EncryptionECDsa, "ECDSA");
			encryptionAlgs.Add(X9ObjectIdentifiers.ECDsaWithSha1.Id, "ECDSA");
			encryptionAlgs.Add(X9ObjectIdentifiers.ECDsaWithSha2.Id, "ECDSA");
			encryptionAlgs.Add(X9ObjectIdentifiers.ECDsaWithSha224.Id, "ECDSA");
			encryptionAlgs.Add(X9ObjectIdentifiers.ECDsaWithSha256.Id, "ECDSA");
			encryptionAlgs.Add(X9ObjectIdentifiers.ECDsaWithSha384.Id, "ECDSA");
			encryptionAlgs.Add(X9ObjectIdentifiers.ECDsaWithSha512.Id, "ECDSA");
			encryptionAlgs.Add(CmsSignedDataGenerator.EncryptionRsaPss, "RSAandMGF1");
			...
			digestAlgs.Add(PkcsObjectIdentifiers.Sha1WithRsaEncryption.Id, "SHA1");
			digestAlgs.Add(PkcsObjectIdentifiers.Sha224WithRsaEncryption.Id, "SHA224");
			digestAlgs.Add(PkcsObjectIdentifiers.Sha256WithRsaEncryption.Id, "SHA256");
			digestAlgs.Add(PkcsObjectIdentifiers.Sha384WithRsaEncryption.Id, "SHA384");
			digestAlgs.Add(PkcsObjectIdentifiers.Sha512WithRsaEncryption.Id, "SHA512");
