...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public class PgpKeyRingGenerator
    {
        ...
        private PgpSignatureSubpacketVector hashedPackets;
        private PgpSignatureSubpacketVector unhashedPackets;
        ...
        public PgpPublicKeyRing GeneratePublicKeyRing()
        {
            ...
            PgpPublicKey pgpPublicKey = pgpSecretKey.PublicKey;
            pubKeys.Add(pgpPublicKey);

            while (enumerator.MoveNext())
            {
                pgpSecretKey = (PgpSecretKey) enumerator.Current;
                pgpPublicKey = new PgpPublicKey(pgpSecretKey.PublicKey);

                PgpPublicKey k = new PgpPublicKey(pgpPublicKey);
                pgpPublicKey.publicPk = new PublicSubkeyPacket(
