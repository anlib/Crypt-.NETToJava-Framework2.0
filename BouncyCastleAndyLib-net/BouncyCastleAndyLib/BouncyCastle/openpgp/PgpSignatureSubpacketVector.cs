...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public class PgpSignatureSubpacketVector
    {
        ...
        {
            SignatureSubpacket p = this.GetSubpacket(SignatureSubpacketTag.IssuerKeyId);
        ...
        {
            SignatureSubpacket p = this.GetSubpacket(SignatureSubpacketTag.CreationTime);
        ...
        {
            SignatureSubpacket p = this.GetSubpacket(SignatureSubpacketTag.KeyExpireTime);
        ...
        {
            SignatureSubpacket p = this.GetSubpacket(SignatureSubpacketTag.PreferredHashAlgorithms);
        ...
        {
            SignatureSubpacket p = this.GetSubpacket(SignatureSubpacketTag.PreferredCompressionAlgorithms);
        ...
        {
            SignatureSubpacket p = this.GetSubpacket(SignatureSubpacketTag.KeyFlags);
        ...
        {
            SignatureSubpacket p = this.GetSubpacket(SignatureSubpacketTag.SignerUserId);
