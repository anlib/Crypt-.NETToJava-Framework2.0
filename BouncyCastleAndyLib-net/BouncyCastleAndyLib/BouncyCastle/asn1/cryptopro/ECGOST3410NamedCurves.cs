    ...
    public sealed class ECGost3410NamedCurves
    {
        ...
        static ECGost3410NamedCurves()
        {
            ...
            ECDomainParameters ecParams = new ECDomainParameters(
                curve,
                new FpPoint(curve,
                new FpFieldElement(curve.Q,new BigInteger("1")), // x
                new FpFieldElement(curve.Q,new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612"))), // y
                mod_q);
            ...
            ecParams = new ECDomainParameters(
                curve,
                new FpPoint(curve,
                new FpFieldElement(mod_p,new BigInteger("0")),
                new FpFieldElement(mod_p,new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247"))),
                mod_q);
