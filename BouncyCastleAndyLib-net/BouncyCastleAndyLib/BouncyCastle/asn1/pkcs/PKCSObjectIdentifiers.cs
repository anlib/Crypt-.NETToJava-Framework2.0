...
namespace Org.BouncyCastle.Asn1.Pkcs
{
    public abstract class PkcsObjectIdentifiers
    {
        ...
        */
        ...
        public static readonly DerObjectIdentifier IdAASignatureTimeStampToken = new DerObjectIdentifier(IdAA + ".14"); // See RFC 3126
        public static readonly DerObjectIdentifier IdAASigPolicyID = new DerObjectIdentifier(IdAA + ".15"); // See RFC 3126
        public static readonly DerObjectIdentifier IdAACommitmentType = new DerObjectIdentifier(IdAA + ".16"); // See RFC 3126
        public static readonly DerObjectIdentifier IdAASignerLocation = new DerObjectIdentifier(IdAA + ".17"); // See RFC 3126
        public static readonly DerObjectIdentifier IdAAOtherSigCert = new DerObjectIdentifier(IdAA + ".19"); // See RFC 3126
        //
